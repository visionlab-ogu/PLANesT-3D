...
<strong>Train:</strong> To start training processing of segmentation run this command:
```
python train.py
```

<strong>Evaluation:</strong> After training, to get prediction of each point in the point cloud and then to get metrics run these commands:
```
python test.py
python eval.py
```
