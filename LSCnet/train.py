...
log_name = 'log_'+METOT+'_'+DATASET
#log_name = 'log_pointnet2_'+DATASET
...
parser.add_argument('--log_dir', default=log_name, help='Log dir [default: log]')
...
os.system('cp %s %s' % (UTIL_FILE, LOG_DIR)) # bkp of util
...
def train():
    with tf.Graph().as_default():
        with tf.device('/gpu:'+str(GPU_INDEX)):
            ...
            # Get model and loss 
            pred, end_points_center, end_points_rad = MODEL.get_model(pointclouds_pl, is_training_pl, bn_decay=bn_decay)
